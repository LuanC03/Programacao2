...
public class ApostaTest {
	...
	public void criaApostaTest() throws Exception {
		...
		aposta3 = new Aposta(3, "Matheus", 456, "Vai Acontecer", 200, 20);
		aposta4 = new Aposta(4, "Darius", 666, "n Vai Acontecer", 0.3, 33);
	}
	...
	@Test(expected = Exception.class)
	public void criaApostaComSegurValorAsseguradoZero() throws Exception {
		aposta3 = new Aposta(3, "Matheus", 456, "Vai Acontecer", 0, 20);
		aposta4 = new Aposta(4, "Darius", 666, "n Vai Acontecer", -7, 33);		
	}
	
	@Test(expected = Exception.class)
	public void criaApostaComSegurTaxaAsseguradaNula() throws Exception {
		aposta3 = new Aposta(3, "Matheus", 456, "Vai Acontecer", 0, 20);
		aposta4 = new Aposta(4, "Darius", 666, "n Vai Acontecer", -0.3, 33);	
	}
	...
	public void representacaoTextualTest() {
		...
		assertEquals("Matheus - R$456,00 - VAI ACONTECER - ASSEGURADA (VALOR) - R$ 200,00", aposta3.toString());
		assertEquals("Darius - R$666,00 - N VAI ACONTECER - ASSEGURADA (TAXA) - 30%", aposta4.toString());		
	}
