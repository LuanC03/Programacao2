...
public class Aposta {
	 ...
	 * @param cenario, int referente ao Cenario que a Aposta esta ligada.
	 * @param apostador, String contendo o autor da Aposta.
	 * @param valor, int referente ao valor da Aposta feita.
	 * @param previsao, String referente ao palpite do autor da Aposta.
	 * @throws Exception 
	 */
	...
	public String toString() {
		...
		return apostador + " - R$" + valor + ",00 - " + retorno ;
	}
}
